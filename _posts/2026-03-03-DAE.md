---
title: 미분대수방정식 (Differential Algebraic Systems of Equations)
sidebar:
  nav: docs-ko
aside:
  toc: true
...
* [라그랑주 승수에 대한 이해](https://angeloyeo.github.io/2020/09/30/SVM.html#2-%EB%9D%BC%EA%B7%B8%EB%9E%91%EC%A3%BC-%EC%8A%B9%EC%88%98%EB%B2%95%EC%97%90-%EB%8C%80%ED%95%9C-%EC%9D%B4%ED%95%B4) - SVM 편에 포함되어 있는 내용입니다.
---
...
<p align = "center">
  <img width = "300" src = "https://raw.githubusercontent.com/angeloyeo/angeloyeo.github.io/master/pics/2026-03-13-DAE/pic1.png">
  <br>
...
$$\begin{aligned} \dot{\mathbf{x}} &= \mathbf{f}(t, \mathbf{x}, \mathbf{z}) \\ \mathbf{0} &= \mathbf{g}(t, \mathbf{x}, \mathbf{z}) \end{aligned} % 식 (2) $$
...
<p align = "center">
  <img width = "300" src = "https://raw.githubusercontent.com/angeloyeo/angeloyeo.github.io/master/pics/2026-03-13-DAE/pic3.png">
  <br>
...
<p align = "center">
  <img width = "300" src = "https://raw.githubusercontent.com/angeloyeo/angeloyeo.github.io/master/pics/2026-03-13-DAE/pic4.png">
  <br>
...
여기서 $\lambda$는 [라그랑주 승수](https://angeloyeo.github.io/2020/09/30/SVM.html#2-%EB%9D%BC%EA%B7%B8%EB%9E%91%EC%A3%BC-%EC%8A%B9%EC%88%98%EB%B2%95%EC%97%90-%EB%8C%80%ED%95%9C-%EC%9D%B4%ED%95%B4)이며 시간에 따라 변하는 변수이다. 우리의 솔버 [ode15s](https://www.mathworks.com/help/matlab/ref/ode15s.html)는 이 $\lambda$ 변수를 포함해서 문제를 풀어주게 된다.
...
<p align = "center">
  <img width = "300" src = "https://raw.githubusercontent.com/angeloyeo/angeloyeo.github.io/master/pics/2026-03-13-DAE/pic5.png">
  <br>
...
<p align = "center">
  <img width = "300" src = "https://raw.githubusercontent.com/angeloyeo/angeloyeo.github.io/master/pics/2026-03-13-DAE/pic6.png">
  <br>
...
포스팅의 마지막을 장식할 **'Simscape와의 연결고리'** 섹션이다. 우리가 직접 코딩하며 겪었던 고생(Index Reduction, $\lambda$ 유도, 드리프트 등)이 Simscape에서 어떻게 자동화되는지 설명하며 마무리하면 독자들에게 큰 통찰을 줄 수 있다.
...
우리가 진자 문제에서 `Index 3` 식을 `Index 1`으로 바꾸기 위해 손으로 두 번 미분했던 과정을 기억하는가? Simscape 엔진은 (정확한 작동 원리는 모르지만, 유저 입장에서 봤을 때) 이 과정을 자동으로 수행해준다. 사용자가 어떤 복잡한 구속 조건을 걸더라도, 솔버가 풀 수 있는 최적의 형태로 수식을 알아서 변형(여기선 Reduction) 해준다.
...
* [1] [Solve Differential Algebraic Equations (DAEs), MathWorks](https://www.mathworks.com/help/matlab/math/solve-differential-algebraic-equations-daes.html)
